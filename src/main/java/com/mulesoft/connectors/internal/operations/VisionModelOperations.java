...
public class VisionModelOperations {
    ...
    public Result<InputStream, LLMResponseAttributes> readImage(
            @Config VisionConfig configuration, @Connection BaseConnection connection,
        ...
        try {
            ...
            TextGenerationConfig inferenceConfig = MuleHttpClientProviderUtils.convertToInferenceConfig(configuration);

            URL chatCompUrl = MuleHttpClientConnectionUtils.getConnectionURLChatCompletion(inferenceConfig, connection);
            ...
            String response = MuleHttpClientConnectionUtils.executeREST(chatCompUrl, inferenceConfig, connection, payload.toString());
