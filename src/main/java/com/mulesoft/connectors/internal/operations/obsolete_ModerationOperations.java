...
import com.mulesoft.connectors.internal.api.delegate.obsolete_Moderation;
...
public class obsolete_ModerationOperations {
    private static final Logger LOGGER = LoggerFactory.getLogger(obsolete_ModerationOperations.class);
    ...
    public Result<InputStream, LLMResponseAttributes> textModeration(
        ...
        try {
            return  obsolete_Moderation.getInstance(configuration).moderate(text);
