 ...
 */
public class MuleHttpClientConnectionUtils {
    ...
    public static HttpRequest buildHttpRequest(URL url, TextGenerationConfig configuration, BaseConnection connection) throws IOException {
     ...
     */
    public static HttpRequestOptions getRequestOptions(TextGenerationConfig configuration, BaseConnection connection) {
     ...
     */
    public static URL getConnectionURLChatCompletion(TextGenerationConfig configuration, BaseConnection connection) throws MalformedURLException {
        switch (connection.getInferenceType()) {
            case "PORTKEY":
     ...
     * @throws MalformedURLException if the URL is invalid
     */
    public static URL getConnectionURLImageGeneration(BaseConnection connection) throws MalformedURLException {
        switch (connection.getInferenceType()) {
            case "OPENAI":
     ...
     */
    public static String executeREST(URL resourceUrl, TextGenerationConfig configuration, BaseConnection connection, String payload) throws IOException, TimeoutException {
        if (resourceUrl == null) {
     ...
     * @throws IOException if an error occurs during the API call
     */
    public static String executeRESTHuggingFaceImage(URL resourceUrl, TextGenerationConfig configuration, BaseConnection connection, String payload) throws IOException, TimeoutException {
        HttpRequest request = buildHttpRequest(resourceUrl, configuration, connection);
        request = HttpRequest.builder()
                .entity(new ByteArrayHttpEntity(payload.getBytes(StandardCharsets.UTF_8)))
                .build();
        HttpRequestOptions options = getRequestOptions(configuration, connection);
