...
public abstract class obsolete_Moderation {
    private static final Logger LOGGER = LoggerFactory.getLogger(obsolete_Moderation.class);
    protected final ModerationConfiguration configuration;

    private static obsolete_Moderation instance;

    /**
     * Constructor for the Moderation class.
     * @param configuration the configuration for the moderation.
     */
    protected obsolete_Moderation(ModerationConfiguration configuration) {
     ...
     */
    public static obsolete_Moderation getInstance(ModerationConfiguration configuration) {
        if (instance == null) {
    ...
    private static obsolete_Moderation findInstance(ModerationConfiguration configuration) {
        switch (configuration.getInferenceType()){
            case "MISTRAL_AI":
                return new obsolete_MistralAIModeration(configuration);
            case "OPENAI":
                return new obsolete_OpenAIModeration(configuration);
            default:
                return null;
        }
    }   
