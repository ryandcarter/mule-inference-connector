...
import com.mulesoft.connectors.internal.operations.obsolete_ImageGenerationOperations;
...
@Operations(obsolete_ImageGenerationOperations.class)
@Configuration(name="image-generation-config-old")
public class obsolete_ImageGenerationConfiguration {
