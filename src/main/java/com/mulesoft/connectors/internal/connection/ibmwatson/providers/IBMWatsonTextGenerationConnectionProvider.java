package com.mulesoft.connectors.internal.connection.ibmwatson.providers;
...
import com.mulesoft.connectors.internal.llmmodels.ibmwatson.providers.IBMWatsonTextGenerationModelNameProvider;
...
public class IBMWatsonTextGenerationConnectionProvider extends TextGenerationConnectionProvider {
    ...
    public void disconnect(TextGenerationConnection baseConnection) {
        logger.debug("IBMWatsonTextGenerationConnection disconnected ...");
    }
    ...
    public ConnectionValidationResult validate(TextGenerationConnection baseConnection) {
        ...
        try {
            ...
            return ConnectionValidationResult.failure("Failed to validate connection to IBM Watson", e);
        }
    }
} 