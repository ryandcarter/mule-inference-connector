package com.mulesoft.connectors.internal.connection.cohere.providers;

import com.mulesoft.connectors.internal.connection.TextGenerationConnection;
import com.mulesoft.connectors.internal.connection.TextGenerationConnectionParameters;
import com.mulesoft.connectors.internal.connection.TextGenerationConnectionProvider;
import com.mulesoft.connectors.internal.connection.cohere.CohereTextGenerationConnection;
import com.mulesoft.connectors.internal.models.cohere.providers.CohereTextGenerationModelNameProvider;
...
public class CohereTextGenerationConnectionProvider extends TextGenerationConnectionProvider {
    ...
    public CohereTextGenerationConnection connect() throws ConnectionException {
        ...
        try {
            ...
            throw new ConnectionException("Invalid Cohere URL", e);
        }
    }

    @Override
    public void disconnect(TextGenerationConnection baseConnection) {
        logger.debug("CohereTextGenerationConnection disconnected ...");
    }
    ...
    public ConnectionValidationResult validate(TextGenerationConnection baseConnection) {
        ...
        try {
            ...
            return ConnectionValidationResult.failure("Failed to validate connection to Cohere", e);
        }
    }
} 