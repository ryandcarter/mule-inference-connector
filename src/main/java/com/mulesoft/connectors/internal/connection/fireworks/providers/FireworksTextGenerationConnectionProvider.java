package com.mulesoft.connectors.internal.connection.fireworks.providers;
...
public class FireworksTextGenerationConnectionProvider extends TextGenerationConnectionProvider {
    ...
    public void disconnect(TextGenerationConnection baseConnection) {
        logger.debug("FireworksTextGenerationConnection disconnected ...");
    }
    ...
    public ConnectionValidationResult validate(TextGenerationConnection baseConnection) {
        ...
        try {
            ...
            return ConnectionValidationResult.failure("Failed to validate connection to Fireworks", e);
        }
    }
} 