package com.mulesoft.connectors.inference.internal.connection.deepinfra.providers;
...
import com.mulesoft.connectors.inference.internal.connection.deepinfra.DeepInfraTextGenerationConnection;
...
public class DeepInfraTextGenerationConnectionProvider extends TextGenerationConnectionProvider {
    ...
    public void disconnect(TextGenerationConnection baseConnection) {
        logger.debug("DeepInfraTextGenerationConnection disconnected ...");
    }
    ...
    public ConnectionValidationResult validate(TextGenerationConnection baseConnection) {
        ...
        try {
            ...
            return ConnectionValidationResult.failure("Failed to validate connection to DeepInfra", e);
        }
    }
} 